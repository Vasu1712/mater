...
import { MaterVoice } from "@/components/MaterVoice";
import { getSnapshot, getAlerts, type Snapshot, type Alert } from "@/lib/api";

const CAR_ID = "acc001";
const CAR_NAME = "Ford Mustang GT (5.0L V8)";
    ...
    <main className="mx-auto max-w-6xl p-6">
      <header className="mb-6 flex items-baseline justify-between">
        <h1 className="text-2xl font-bold">
          Driver <span className="text-slate-500">· {snap?.car_name ?? CAR_NAME}</span>
        </h1>
